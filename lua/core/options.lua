...
-- Syntax highlight
vim.opt.syntax = "off"  -- Отключить стандартную подсветку синтаксиса

-- Отключить все дефолтные color schemes
vim.cmd([[
  augroup RemoveDefaultColors
    autocmd!
    autocmd ColorScheme * silent! colorscheme default
  augroup END
]])
